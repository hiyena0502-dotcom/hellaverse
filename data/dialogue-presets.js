...
(()=>{
  ...
  const LUCIFER_LOW_AFFECTION_COURTESY={
    "천사가 호텔에서 죄인과 직접 생활한다면":["불편한 부분은 넘겨도 된다고 한다","불편한 얘기면 굳이 다 답 안 하셔도 돼요.","전부 말할 생각은 없었어. 필요한 만큼만 말하지."],
    "다른 지역에도 재활 시설을 세워야 하는가":["직접 맡아달라는 뜻은 아니라고 말한다","의견만 궁금한 거예요. 직접 맡아달라는 뜻은 아니고요.","그 정도면 됐네. 의견만 말하면, 아직 다른 데까지 벌일 생각은 없어."],
    "호텔에 게임룸을 만들자는 의견":["운영은 다른 사람에게 맡기고 취향만 묻는다","운영은 다른 사람이 한다 치고, 당신은 뭐가 있으면 좋겠어요?","핀볼. 하나만 고르면 그거. 오리는 장식이 아니라 필수고."],
    "호텔이 오버로드 정치에서 중립을 유지할 수 있는가":["복잡한 정치 얘기는 여기서 접는다","복잡한 얘기면 여기까지만 할게요.","정치 얘기는 길어지면 재미없어. 여기서 끊자."],
    "호텔에서 같이 술 마시기 좋은 사람":["이유는 캐묻지 않고 취향만 듣는다","이유는 안 물을게요. 그냥 편한 사람이 누구인지 정도만요.","비나 오지 정도. 더 캐묻진 마."],
    "호텔 단체 사진을 찍으려다 난장판이 되는 상황":["사진이 싫으면 빠져도 된다고 한다","굳이 찍기 싫으면 안 찍어도 되죠.","찰리가 부르면 한 장은 찍어. 그 이상은 싫고."],
    "냉장고에 넣어둔 음식을 누가 자꾸 훔쳐 먹는가":["범인을 몰아세우지 말고 새로 채우자고 한다","범인 찾는 대신 새로 채워둘까요?","그게 낫겠네. 내가 먹으려고 둔 것만 다시 채워."],
    "호텔 직원들의 휴일을 정하는 문제":["근무표를 맡기려는 건 아니라고 한다","당신한테 근무표를 짜달라는 건 아니에요.","잘됐네. 난 휴무표 담당 아니야."],
    "호텔 멤버 전원이 아무 일도 하지 않고 쉬는 날을 보내려다 결국 사고가 나는 상황":["오늘만큼은 그냥 쉬어도 된다고 한다","사고 나기 전까진 그냥 쉬세요. 뭔가 맡기려는 건 아니고요.","그 말은 마음에 드네. 아무 일 없으면 아무것도 안 할 거야."],
    "호텔을 왕실이 공식적으로 지원해야 하는가":["공식 지원을 강요하는 건 아니라고 한다","왕실 도장 찍으라는 얘기는 아니에요. 필요한 만큼만 도우면 되죠.","필요한 데 한두 번 손 보태는 건 해. 정식 사업은 사양이고."],
    "권력자가 평범한 Hellborn의 삶을 얼마나 이해할 수 있는가":["모르는 부분이 있어도 탓하지 않는다","모르는 부분이 있어도 이상한 건 아니라고 생각해요.","당연히 모르는 것도 있지. 그걸 하나하나 변명할 생각은 없어."],
    "찰리가 직접 모든 투숙객을 관리하는 건 가능한가":["찰리의 선택을 존중하자고 한다","찰리가 원하면 맡기고, 필요할 때만 도와도 되겠죠.","그 애가 먼저 해보게 두면 돼. 부르면 가고."],
    "호텔 멤버 중 노래방에서 가장 시끄러운 사람":["순위는 더 캐묻지 않겠다고 한다","그 정도만 알면 됐어요. 더 순위 매기진 않을게요.","그 긴 거미가 제일 시끄럽다. 그 이상은 안 매길래."],
    "지옥 주민이 천국을 관광할 수 있는 날이 올까":["천국 얘기가 불편하면 넘긴다","천국 얘기가 불편하면 여기까지만 할게요.","오늘은 여기까지 하자. 다음에 내가 먼저 얘기할 수도 있고."],
    "호텔 요리 대회":["심사까지 맡기려는 건 아니라고 한다","심사위원 하라는 건 아니고, 그냥 구경만 해도 돼요.","구경은 하지. 먹어야 한다는 조건만 없으면."],
    "구원이 증명된 뒤 갑자기 호텔에 찾아오는 죄인들":["몰려온 사람들을 전부 맡기려는 건 아니라고 한다","사람이 몰려와도 당신이 다 처리하라는 뜻은 아니에요.","당연히 찰리 호텔이지 내 민원실은 아니잖아. 필요하면 도와주고."],
    "호텔에서 가장 믿으면 안 되는 사람":["굳이 누구 이름까지 말하지 않아도 된다고 한다","굳이 누구 이름까지 말할 필요는 없어요.","이름까지는 안 말할래. 아직 그 얘기 할 사이는 아니잖아."],
    "호텔에서 술을 제한해야 하는가":["규칙을 직접 정해달라는 건 아니라고 한다","규칙을 직접 정하라는 건 아니에요. 의견만 듣고 싶었어요.","술 자체를 막을 필요는 없어. 사고 치면 그때 제지하면 되지."],
    "호텔에서 절대 맡기면 안 되는 사람이 요리를 한다면":["확인한다고 직접 먹어볼 필요는 없다고 한다","확인하겠다고 직접 먹어볼 필요는 없어요.","다행이네. 냄새만으로도 판단 끝날 것 같은데."],
    "호텔에서 가장 편한 소파를 누가 차지하는가":["원한다면 자리를 양보한다","원하시면 그 소파 쓰세요. 전 다른 데 앉을게요.","그 소파는 내가 쓸게. 너는 옆에 앉아."],
    "지옥에서 평판이 곧 권력인가":["정확한 분석까지 요구하지 않는다","정확한 분석까지 부탁한 건 아니에요. 느낌만 들으면 돼요.","이름값도 힘이긴 해. 내가 굳이 자세히 뜯어볼 정도는 아니고."],
    "힘센 Sinner가 Hellborn 귀족보다 낮은 취급을 받는 문제":["당장 해결책까지 요구하지 않는다","당장 해결책을 내놓으라는 건 아니에요.","그 차별이 있는 건 알아. 고칠 방법까지 지금 내놓으라면 몰라."],
    "호텔의 성공으로 오버로드 체제가 약해질 가능성":["미래를 맞혀달라는 건 아니라고 한다","미래를 맞혀달라는 건 아니에요. 여기까지만 할게요.","실제로 흔들리면 보이지. 지금은 모른다."],
    "천사가 호텔에 장기 체류한다면 어떤 문제가 생길까":["개인적인 천국 경험은 묻지 않는다","개인적인 천국 얘기까지 하실 필요는 없어요.","그건 안 묻는 편이 나아. 장기 체류 자체는 찰리랑 천사 쪽이 정해야지."],
    "Lute를 호텔에 들여보낼 수 있는가":["결정은 찰리에게 맡기자고 한다","들일지 말지는 찰리가 정할 일이겠죠. 당신 생각만 궁금했어요.","내 생각? 경계는 할 거야. 들일지는 찰리가 정하고."],
    "지옥에서 왕족의 존재가 정말 필요한가":["왕관을 내려놓으라는 뜻은 아니라고 한다","당신한테 왕관 내려놓으라는 뜻은 아니에요.","그럴 생각은 없으니까 다행이네. 필요한지 아닌지는 별개로, 왕은 나야."],
    "호텔이 아니라 Hellborn용 상담소가 생긴다면 갈 의향이 있는가":["상담을 강요하려는 건 아니라고 한다","가라고 강요하려는 건 아니에요. 싫으면 안 가도 되고요.","지금은 갈 생각 없어. 나중엔 모르지."],
    "지옥에서 명성과 실제 권력은 같은 것인가":["누구와 비교하지 않아도 된다고 한다","굳이 누구랑 비교하지 않아도 돼요.","명성과 힘은 같지 않아. 그 정도만 알면 돼."],
    "각 Ring의 음식 중 가장 먹어보고 싶은 것":["생각나는 것 하나만 말해달라고 한다","정답처럼 고를 필요 없어요. 생각나는 것 하나만요.","달고 기름진 거. 오늘은 그쪽."],
    "지옥에서 혁명이 벌어진다면 누가 가장 먼저 반응할까":["예측까지 요구하지 않는다고 한다","누가 먼저 움직일지 맞혀달라는 건 아니에요.","그건 실제로 터지면 보자. 지금은 예측 안 해."],
    "지옥에서 가장 끔찍한 관광지":["직접 안내까지 할 필요는 없다고 한다","직접 안내하실 필요는 없고, 피하고 싶은 곳만 말해줘도 돼요.","마몬 있는 데는 대체로 피곤해. 그 정도면 충분하지?"],
    "천국 음식은 지옥 음식과 얼마나 다를까":["기억나지 않으면 떠올리지 않아도 된다고 한다","기억 안 나면 굳이 떠올리지 않으셔도 돼요.","기억은 나. 지금 비교하고 싶은 기분은 아니야. 다음에 물어봐."],
    "Hellborn이 천국에 관심을 가질 이유가 있는가":["개인 경험까지 캐묻지 않는다고 한다","당신 경험까지 캐묻는 건 아니에요.","관심 가질 이유야 있겠지. 내가 개인 경험까지 보태고 싶진 않고."],
    "라디오와 텔레비전 중 어떤 매체가 더 영향력이 있는가":["누가 더 강한지까지 묻지 않는다","누가 더 강한지까지 말할 필요는 없어요.","지금은 텔레비전 쪽이 더 시끄럽지. 영향력까지 누가 위인지 재볼 생각은 없어."],
    "다른 사람 옷을 하루 동안 입어보기":["허락 없이 옷을 건드리지 않겠다고 한다","당신 옷은 허락 없이 건드리지 않을게요.","그건 잘했네. 내 옷은 내가 입는 게 제일 낫거든."],
    "인간 세계의 술과 지옥의 술 비교":["최근 인간 세상 사정까지 요구하지 않는다","최근 인간 세상 사정까지 아실 필요는 없죠.","옛날 기억으로만 말하면 인간 술이 좀 덜 과했어. 최근 건 몰라."],
    "방송에 호텔 내부를 공개해야 하는가":["방송 출연을 강요하지 않는다","당신까지 방송에 나와야 한다는 뜻은 아니에요.","난 안 나가. 찰리 필요하면 잠깐 얼굴 비추는 정도."],
    "호텔 전체에 인터넷이 끊긴 상황":["수리를 맡기려는 건 아니라고 한다","고쳐달라는 건 아니에요. 그냥 인터넷이 끊겼다고 알려드린 거예요.","찰리 여자친구나 기계 잘 아는 애한테 말해. 난 안 고쳐."],
    "귀족사회에서 진짜 친구를 구별하는 방법":["개인적인 관계까지 묻지 않는다","누가 친구였는지까지 말하지 않으셔도 돼요.","원칙만 말하면, 오래 봤다고 친구는 아니야. 개인 이름은 다음에."],
    "호텔에 통금 시간이 필요한가":["직접 단속할 필요는 없다고 한다","통금이 생겨도 당신이 단속할 필요는 없겠죠.","단속은 안 해. 필요하면 찰리 쪽에서 정하겠지."],
    "호텔 로비에서 잠드는 사람들에 대한 불만":["거슬리지 않으면 그냥 두자고 한다","거슬리지 않으면 그냥 두죠. 굳이 깨울 필요 없고요.","안 시끄러우면 냅둬. 내 소파만 아니면."],
    "카드 게임에서 가장 사기 칠 것 같은 사람":["진지하게 의심하는 건 아니라고 한다","진짜 범인 취급하려는 건 아니에요. 그냥 장난으로 물은 거예요.","장난이면 사슴 대가리. 이유는 굳이 안 물어봐."],
    "호텔이 정말 성공하면 그다음에는 무엇을 해야 하는가":["바로 다음 계획을 세우라는 뜻은 아니라고 한다","성공하자마자 다음 계획 세우라는 뜻은 아니에요.","성공하면 먼저 쉬어. 그다음은 찰리가 정하겠지."],
    "호텔 운영비는 어디서 마련해야 하는가":["장부까지 보라는 뜻은 아니라고 한다","장부 보라는 뜻은 아니에요. 숫자는 다른 사람이 봐도 되죠.","숫자는 찰리 쪽에서 보라고 해. 부족해서 진짜 문제 생기면 그때 부르고."],
    "복스텍 제품을 호텔에서 사용해도 되는가":["당장 부수자는 건 아니라고 한다","당장 부수자는 건 아니에요. 불편하면 안 써도 되고요.","기계가 멀쩡하면 써. 로고는 보기 싫지만."],
    "Satan 같은 권력자가 법정에서 얼마나 큰 권한을 가져야 하는가":["루시퍼의 권한을 의심하는 건 아니라고 한다","당신 권한을 의심하려는 건 아니에요.","내 권한과 비교할 건 아니고. 사탄 재판은 사탄 몫이야."],
    "죄악들 사이에도 서열 의식이 존재하는가":["굳이 전부 줄 세우지 않아도 된다고 한다","굳이 전부 줄 세우지 않아도 돼요.","맨 위는 나. 그 밑을 굳이 줄 세울 생각은 없어."],
    "호텔에서 가장 이상한 취미를 가진 사람":["오리를 이상한 취미라고 한 건 아니라고 한다","오리는 이상한 취미라고 한 건 아니에요.","오리는 정상 범주야. 그 전제면 계속해."],
    "지옥식 휴가 계획을 세우기":["일정표까지 짜달라는 건 아니라고 한다","일정표까지 짜달라는 건 아니에요. 쉬고 싶은지만 물은 거예요.","일정표 없으면 생각해볼 수 있어. 숙소 예약은 네가 해."],
    "호텔의 실패 사례도 공개해야 하는가":["개인적인 실패까지 공개하자는 건 아니라고 한다","개인적인 실패까지 공개하자는 뜻은 아니에요.","내 얘기까지 공개할 필요는 없어. 호텔 사례만 보면 되잖아."],
    "호텔에 자꾸 물건이 사라지는 문제":["누구를 도둑으로 몰지는 말자고 한다","누굴 도둑으로 몰자는 건 아니에요. 찾기만 하면 돼요.","찾기만 해. 범인 잡기 놀이는 귀찮아."],
    "누군가 익명의 선물을 두고 간 상황":["허락 없이 선물을 열지 않겠다고 한다","당신 앞으로 온 거면 제가 먼저 열진 않을게요.","손대지 마. 내가 먼저 볼게. …물어본 건 잘했네."],
    "Sinsmas 선물을 누구에게 줄 것인가":["모두 챙길 의무는 없다고 한다","모두 챙겨야 한다는 뜻은 아니에요. 주고 싶은 사람만 주면 되죠.","전부 챙길 생각 없어. 생각나는 애들만."],
    "언젠가 호텔이 더 이상 필요 없는 곳이 될 수 있을까":["미래 얘기는 여기서 멈춰도 된다고 한다","지금 답하기 어려우면 미래 얘긴 여기까지만 해도 돼요.","오늘은 거기까지 생각 안 할래. 미래의 나한테 맡겨."],
    "새 투숙객의 방을 누가 안내할 것인가":["직접 안내를 맡기려는 건 아니라고 한다","당신이 직접 안내하라는 뜻은 아니에요.","직접 하진 않을 거야. 호텔 사람 중 한 명이 하면 되지."],
    "호텔에 반려동물을 들여도 되는가":["규칙표를 만들자는 얘기는 아니라고 한다","규칙표 만들자는 얘기는 아니에요. 그냥 괜찮은지만요.","작고 안 물면 괜찮지 않을까. 규칙은 찰리가 정하고."],
    "술 취하면 가장 위험한 사람":["누가 최악인지 정하지 않아도 된다고 한다","굳이 누가 최악인지 정하지 않아도 돼요.","누구 하나 찍진 않을래. 술 취하면 다 귀찮아져."],
    "호텔에 전문 상담사가 필요한가":["루시퍼에게 상담을 강요하지 않는다","당신도 꼭 상담받으라는 뜻은 아니에요.","지금 나까지 상담실에 밀어 넣진 마. 상담사 자체는 있어도 되겠지."],
    "호텔 조식 메뉴를 누가 정해야 하는가":["메뉴 회의 대신 하나만 묻는다","메뉴 회의하자는 건 아니에요. 좋아하는 것 하나만 말해줘요.","팬케이크. 다른 안건 없으면 회의 끝."],
    "누가 가장 최악의 요리를 만드는가":["직접 먹고 판정할 필요는 없다고 한다","직접 먹고 판정하라는 건 아니에요.","그 조그만 애. 칼질 속도부터 식사랑 안 어울려."],
    "오리 설계":["허락하기 전에는 설계도를 만지지 않는다","허락하기 전엔 설계도 안 만질게요.","손대지만 마. 보고 싶은 건 봐도 돼."],
    "왕관 손질":["왕관은 건드리지 않고 보기만 한다","왕관은 건드리지 않을게요. 그냥 보고만 있을게요.","보기만 해. 이건 아무한테나 맡기는 물건 아니니까."],
    "낡은 악보":["말하기 싫은 곡이면 더 묻지 않는다","말하기 싫은 곡이면 묻지 않을게요.","오늘은 안 들려줄래. 다음에 내가 꺼내면 그때 물어봐."],
    "가족사진":["설명을 요구하지 않고 사진도 건드리지 않는다","설명 안 하셔도 돼요. 사진도 안 건드릴게요.","사진 얘기는 아직 이르네. 그냥 거기 둬."],
    "사과 연습":["못 본 걸로 하고 연습을 계속하게 둔다","못 본 걸로 할게요. 연습 계속하세요.","그렇게 해. 이건 혼자 할게."],
    "천국의 깃털":["허락하기 전에는 깃털을 만지지 않는다","허락하기 전엔 안 만질게요.","손대지 마. 보고만 있는 건 괜찮아."],
    "호텔 열쇠":["찰리가 준 물건에는 손대지 않는다","찰리가 준 거면 제가 손대지 않을게요.","그건 내가 챙겨. 찰리가 준 거니까."],
    "왕실 업무 회피":["재촉하지 않고 급한 것만 나중에 보라고 한다","재촉하진 않을게요. 급한 것만 나중에 확인하세요.","급한 건 나중에 골라볼게. 지금은 안 해."],
    "천국 이야기":["말하기 싫다면 여기서 그만 묻는다","말하기 싫으시면 여기서 그만 물을게요.","오늘은 여기까지. 다음에 내가 말하고 싶으면 말할게."],
    "찰리의 메모":["회의에 갈지 재촉하지 않는다","회의 갈지 말지는 직접 정하세요. 전 재촉 안 할게요.","재촉 안 해도 갈 거야. …아마. 찰리 기다리기 전에 가야겠네."]
  };
