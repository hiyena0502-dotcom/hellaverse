...
(()=>{
  ...
  replace("각 Ring의 음식 중 가장 먹어보고 싶은 것",id=>EV(id,"각 Ring의 음식 중 가장 먹어보고 싶은 것","CHARACTER_OPEN","light",[
    ...
    CH(id+"-choice","Ring의 음식을 어떻게 골라볼까?",[
      ...
      O(id+"-all","Pride·Sloth·Envy까지 전부 고르라고 한다","light",[P(id+"-all-player","Pride, Sloth, Envy까지 전부 하나씩 골라봐요."),...BR(id+"-all-r",{COLD:{lines:"갑자기 지옥 음식 평가표 만들 거야? Pride는 늘 먹고, 나머진 당사자한테 물어봐.",effects:[add(id+"-all-work-cold","luc_work_avoidance",1)]},DISTANT:{lines:"과제처럼 시키지 마. Sloth는 벨페고르, Envy는 레비아탄한테 물어봐.",effects:[add(id+"-all-work-dist","luc_work_avoidance",1)]},NEUTRAL:{lines:"Pride는 여행 음식이 아니고, Sloth와 Envy는 내가 아는 척하지 않을게. 당사자 추천이 낫지.",effects:[add(id+"-all-work-neutral","luc_work_avoidance",1)]},WARM:{lines:"하! 메뉴판 숙제네. Pride는 제외, Sloth와 Envy는 벨페고르랑 레비아탄에게 넘기자.",effects:[add(id+"-all-work-warm","luc_work_avoidance",1)]},CLOSE:{lines:"전부 고르는 건 귀찮아. 대신 같이 가면 네가 고른 걸 한입씩 뺏어 먹을게. 훨씬 효율적이지.",effects:[add(id+"-all-work-close","luc_work_avoidance",1),add(id+"-all-food-close","luc_food_interest",1)]}})])
    ])
  ]));
