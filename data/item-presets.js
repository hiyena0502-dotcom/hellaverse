  ...
  function voice(character,item,phase,pref){
    ...
    const lines={
      ...
      angeldust:{
        ...
        repeat:`또 챙겨왔네? 나 버릇 나빠지면 네 책임이다. 선물 다음엔 키스냐고 물어보진 마, 내가 먼저 물을 거니까.`,
      ...
      blitzo:{
        first:disliked?`뭐야, 「${n}」? 이걸 받고 내가 감동해서 바지라도 벗길 바란 건 아니지? …씨발, 일단 줘 봐.`:`오, 「${n}」! 생각보다 내 취향 잘 맞혔는데? 훔친 건 아니고? 훔쳤어도 솔직히 점수는 준다.`,
        repeat:`또 가져왔냐? 좋아, 이제 네 선물 루트에 내가 박혀 있다는 건 확실하네. 표현 이상하다고? 일부러야.`,
      ...
      asmodeus:{
        first:disliked?`자기야, 마음은 예쁜데 「${n}」은 분위기 다 죽이네. 섹시함에도 최소한의 연출은 필요하다고. 그래도 받아둘게.`:`오, 「${n}」? 센스 있네. 선물도 유혹이랑 같아. 상대를 보고 골라야지, 넌 그건 제대로 했어.`,
        repeat:`또 준비했어? 좋아. 이쯤 되면 네가 날 어떤 취향으로 보는지 꽤 선명한데. 나쁘지 않아.`,
        special:`진짜 매력적인 건 물건보다 솔직한 마음이야. 네가 내 경계도, 내 취향도 기억해준다는 게 제일 좋네.`
      },
      beelzebub:{
      ...
      velvette:{
        first:disliked?`아니, 「${n}」? 자기야, 이걸 피드에 올리면 알고리즘이 나한테 개인적으로 사과해야 돼. 받아는 둘게. 사진은 절대 안 찍고.`:`「${n}」? 오, 생각보다 안 촌스럽네. 네 안목이 드디어 사람 취급 받을 수준까진 업데이트됐어.`,
        repeat:`또 이거? 일관된 콘셉트는 좋아. 근데 네가 찍으면 망하니까 사진 각도는 내가 정해.`,
        special:`좋아, 이건 진짜 마음에 들어. 네가 골랐다는 태그는 비공개로 달아둘게. 공개하면 네 팔로워까지 봐야 하잖아.`
      },
      valentino:{
        first:disliked?`이걸 나한테? 씨발, 자기야. 플로리다 관광 기념품 가게에서도 이것보단 덜 구린 걸 팔겠다. 그래도 두고 가.`:`「${n}」이라. 제법 화려하네. 내 시선 끈 건 칭찬해줄게. 그게 생각보다 어려운 일이거든.`,
        repeat:`또 선물이야? 존나 끈질기네. 뭐, 나한테 퍼주는 취미라면 막을 이유는 없지.`,
        special:`이건 남한테 안 넘기고 내가 가질게. 씨발, 됐지? 내가 직접 보관한다는 게 얼마나 큰 칭찬인지 알아먹어.`
      },
      carmillacarmine:{
      ...
      fizzarolli:{
        ...
        repeat:`앙코르 선물이야? 좋아! 같은 것도 연출만 바꾸면 새로워지는 법이지. 광대가 괜히 광대겠어?`,
        special:`농담 빼고 말하면… 네가 나한테 ‘웃겨봐’가 아니라 ‘네가 좋아할 것 같아서’ 준 게 좋아. 그런 차이, 생각보다 크게 느껴지거든.`
      },
      octavia:{
