...
(()=>{
  ...
  function voice(character,item,phase,pref){
    ...
    const lines={
      ...
      angeldust:{
        first:disliked?`어우, 자기야. 이건 좀 아니지. 내 취향 죽이려는 암살 시도야? 그래도 네가 준 거니까 바로 버리진 않을게.`:`오, 자기. 「${n}」? 센스 있는데? 이렇게 자꾸 잘 고르면 내가 이상한 농담 말고 진짜 고맙다고 해야 하잖아.`,
        repeat:`또 챙겨왔네? 나 버릇 나빠지면 네 책임이다. 선물 다음엔 키스냐고 묻지 마, 내가 먼저 물어보고 네 표정부터 구경할 거니까.`,
        special:`…농담 빼고, 고마워. 대가나 조건부터 안 붙이고 뭘 주는 사람은 생각보다 드물거든. 그래서 네 건 좀 오래 기억해.`
      },
      husk:{
      ...
      adam:{
        first:disliked?`뭐야, 이딴 걸 나한테 준다고? 존나 웃기네. 이걸 고른 눈으로 연애는 어떻게 하냐? …됐어, 두고 가.`:`오, 「${n}」? 드디어 좀 보는 눈이 생겼네. 당연하지, 나 같은 남자한텐 이 정도는 와야지.`,
        repeat:`또 가져왔냐? 하, 그래. 나한테 선물하는 맛 들였네. 이해한다. 나라도 나한테 뭐든 퍼주고 싶을 듯.`,
        special:`씨발, 알았어. 이건 진짜 마음에 든다. 물건도 물건인데 네가 내 취향 외운 게 좀… 괜찮네. 너무 우쭐대진 마.`
      },
      vox:{
      ...
      blitzo:{
        first:disliked?`뭐야, 「${n}」? 이거 주면 내가 바로 넘어갈 줄 알았냐? 존나 귀엽네. …씨발, 일단 줘 봐.`:`오, 「${n}」! 생각보다 내 취향 잘 맞혔는데? 훔친 건 아니고? 훔쳤어도 솔직히 점수는 준다.`,
        repeat:`또 가져왔냐? 좋아, 이제 네 선물 루트에 내가 깊숙이 박혀 있다는 건 확실하네. 그래, 표현 일부러 그렇게 골랐다.`,
        special:`이런 거 계속 주면 내가 정든 티 내야 하잖아. 존나 싫네. …근데 고맙다. 진짜로.`
      },
      paimon:{
      ...
      asmodeus:{
        first:disliked?`자기야, 마음은 예쁜데 「${n}」은 분위기 다 죽이네. 섹시함에도 최소한의 연출은 필요하다고. 그래도 받아둘게.`:`오, 「${n}」? 센스 있네. 선물도 유혹이랑 같아. 어디를 자극해야 먹히는지 알아야 하거든. 넌 포인트 잘 잡았어.`,
        repeat:`또 준비했어? 좋아. 이쯤 되면 네가 날 어떤 취향으로 보는지 꽤 선명한데. 나쁘지 않아.`,
        special:`진짜 매력적인 건 물건보다 솔직한 마음이야. 네가 내 취향은 기억하면서도 선 넘지는 않는다는 게 제일 섹시하지.`
      },
      beelzebub:{
      ...
      cherribomb:{
        first:disliked?`야, 이건 좀 구린데. 우리 아직 이런 거 취향 맞춰줄 사이였냐? …그래도 직접 들고 왔으니 버리진 않을게.`:`오, 「${n}」? 존나 괜찮은데? 생각보다 보는 눈 있네. 너무 뿌듯해하진 마.`,
        repeat:`또 가져왔냐? 좋아, 이쯤 되면 네가 다음에 뭘 들고 올지 좀 기대되는데.`,
        special:`진짜 고맙다. 요즘은 누가 나 생각해서 뭘 골랐다는 게 예전보다 더 크게 느껴져. 다음엔 선물 말고 같이 나가자.`
      },
      velvette:{
        first:disliked?`아니, 「${n}」? 자기야, 이걸 피드에 올리면 알고리즘이 나한테 개인적으로 사과해야 돼. 받아는 둘게. 사진은 절대 안 찍고.`:`「${n}」? 오, 생각보다 안 촌스럽네. 네 안목이 드디어 내가 침대 옆 협탁에 놔도 욕 안 먹을 수준까진 업데이트됐어.`,
        repeat:`또 이거? 일관된 콘셉트는 좋아. 근데 네가 찍으면 망하니까 사진 각도는 내가 정해.`,
        special:`좋아, 이건 진짜 마음에 들어. 네가 골랐다는 태그는 비공개로 달아둘게. 공개하면 사람들이 우리 사이를 지들 멋대로 야하게 편집할 테니까.`
      },
      valentino:{
        first:disliked?`이걸 나한테? 씨발, 자기야. 플로리다 싸구려 모텔 자판기에서도 이것보단 덜 구린 걸 뱉겠다. 그래도 두고 가.`:`「${n}」이라. 제법 화려하네. 내 시선 끈 건 칭찬해줄게. 그게 생각보다 어려운 일이거든.`,
        repeat:`또 선물이야? 존나 끈질기네. 뭐, 나한테 퍼주는 게 네 취향이면 굳이 치료해줄 생각은 없어.`,
        special:`이건 남한테 안 넘기고 내가 가질게. 씨발, 됐지? 내가 직접 손에 쥐고 안 놔준다는 게 얼마나 큰 칭찬인지 알아먹어.`
      },
      carmillacarmine:{
      ...
      stolas:{
        first:disliked?`아… 「${n}」. 제법 난처한 기억을 부르는군요. 성의는 감사하지만 아직은 가까이 두고 싶진 않네요.`:`「${n}」이군요. 세심한 선택입니다. 감사합니다. 제 서재 어딘가에 잘 두도록 하지요.`,
        repeat:`또 가져오셨군요. 이렇게까지 신경 쓰실 필요는 없는데… 그래도 감사히 받겠습니다.`,
        special:`이상하군요. 궁전의 값비싼 물건보다 당신이 직접 골라준 이 작은 선물이 더 따뜻하게 느껴집니다. 왜 그런지 이제는 조금 알 것 같아요.`
      },
      loona:{
      ...
      fizzarolli:{
        first:disliked?`「${n}」? 와, 관객 반응이었다면 야유 타이밍이다! 그래도 선물한 용기는 박수 쳐줄게. 짝짝.`:`오호, 「${n}」! 무대 소품으로 써도 되고 내 방에 둬도 되겠는데? 오늘 관객 센스 합격!`,
        repeat:`앙코르 선물이야? 좋아! 같은 것도 연출만 바꾸면 새로워지는 법이지. 밤도 농담도 타이밍 바꾸면 완전 다른 맛 나거든.`,
        special:`농담 빼고 말하면… 네가 나한테 ‘웃겨봐’나 ‘한번 꼬셔봐’가 아니라 그냥 ‘네가 좋아할 것 같아서’ 준 게 좋아. 그런 차이, 생각보다 크게 느껴지거든.`
      },
      octavia:{
        first:disliked?`어… 「${n}」. 솔직히 내 취향은 아니야. 그리고 우리 아직 서로 취향 챙겨줄 정도로 친하진 않잖아. 그래도… 고마워.`:`「${n}」? 괜찮네. 생각보다 내 방에 둬도 안 거슬릴 것 같아.`,
        repeat:`또 가져왔네. 네가 계속 이러니까 이제 좀 익숙해졌어. 싫다는 뜻은 아니고.`,
        special:`누가 내 취향을 기억해주는 게 아직 낯설어. 집에서는 다들 자기 문제로 바쁘니까. 그래서… 좋은 쪽으로 낯설어.`
      }
    };
    const fallback={
