...
(()=>{
  ...
  const PLAYER_ECHO=[
    (c,t)=>"당신은 평소 "+playerLens(c)+" 쪽을 많이 보잖아요. 그래서 이 답은 더 다를 것 같아요.",
    (c,t)=>"방금 반응을 보니 ‘"+t+"’을 일반론으로만 묻기는 어렵네요. 당신 기준도 같이 듣고 싶어요.",
    (c,t)=>"평소 "+playerLens(c)+"를 중요하게 보는 걸 생각하면 이 문제의 우선순위도 궁금해져요.",
    (c,t)=>"‘"+t+"’을 당신 방식대로 풀면 어디서부터 달라지는지 듣고 싶어요.",
    (c,t)=>"같은 질문을 다른 사람에게 했을 때와는 전혀 다른 답이 나올 것 같아서 물어요. 특히 "+playerLens(c)+" 쪽에서요.",
    ...
    (c,t)=>"이건 다른 사람 의견 말고 정말 당신 판단을 듣고 싶어요. "+playerLens(c)+"를 생각하면 더 그래요.",
