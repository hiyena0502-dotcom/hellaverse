...
(()=>{
  ...
  for(const c of PFS){
    const list=chosen(c);
    window.HV_STORY_PACKS.push({id:"pooltalk-52-"+slug(c.id),version:48,requiredCharacterIds:[c.id],events:list.map((t,n)=>splitEventDialogues(uniqueDialogueEvent(c,t,make(c,t,n))))});
  }
})();