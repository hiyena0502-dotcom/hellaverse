...
(()=>{
  ...
  const CUE={
    hotel:["공동생활은 좋은 의도만으로 굴러가지 않아","생활 규칙은 누가 배려받고 누가 떠맡는지를 드러내","작은 운영 문제에도 관계의 우선순위가 보여"],
    redemption:["다시 시작하는 것과 과거를 지우는 건 전혀 다른 일이야","변화는 말보다 반복되는 선택으로 확인해야 해","기회를 준다고 책임까지 대신 져주는 건 아니지"],
    heaven:["천국이라는 이름만으로 모든 판단이 옳아지는 건 아니야","질서는 필요하지만 질문이 금지되는 순간부터 위험해져","완벽해 보이는 곳일수록 모순을 인정하기 어려워"],
    extermination:["명령을 받았다는 사실과 자신이 한 선택은 따로 봐야 해","전쟁이 끝나도 기억과 원한은 그대로 남아","살아남은 사람에게 화해의 속도를 강요할 수는 없어"],
    soul:["계약은 문장보다 실제 선택권이 있었는지가 중요해","힘을 얻는 거래일수록 잃는 쪽을 나중에 알아차리기 쉬워","소유와 동의가 같은 말처럼 취급되면 바로 문제가 생겨"],
    media:["보이는 장면과 실제 상황이 다를수록 누가 편집권을 가졌는지가 중요해","관심을 얻는 것과 신뢰를 얻는 건 완전히 다른 기술이야","사람들은 사실보다 반복해서 본 이미지를 더 빨리 믿기도 해"],
    tech:["새로운 도구는 편리함만큼 누가 통제하는지도 봐야 해","장비가 좋아도 쓰는 사람이 엉망이면 결과는 똑같아","기능보다 실패했을 때 무엇이 망가지는지 먼저 보는 편이 안전해"],
    power:["힘을 가진 이유와 그 힘을 쓸 자격은 같은 질문이 아니야","권력은 명령보다 결과를 감당할 때 더 선명해져","사람이 복종한다고 존경하는 건 아니지"],
    family:["가족은 사랑만으로 정리되지 않고 오래된 기대와 상처까지 같이 움직여","보호하려는 마음이 상대의 선택을 대신해버릴 때가 가장 위험해","가족이라는 이유가 모든 행동의 면죄부가 될 수는 없어"],
    romance:["좋아한다는 감정과 상대를 가질 권리는 전혀 다른 문제야","사랑은 서로의 결정을 존중할 때 오래가","화해나 이별을 한쪽이 혼자 정할 수는 없어"],
    trust:["신뢰는 한 번의 멋진 말보다 작은 행동이 오래 반복될 때 생겨","경계를 존중해주는 사람이 결국 더 가까운 사람이 되더라","비밀을 아는 것과 그 비밀을 맡을 자격이 있는 건 달라"],
    past:["과거를 설명한다고 현재의 선택이 자동으로 정당해지는 건 아니야","오래된 기억은 사라지지 않아도 다루는 방식은 바뀔 수 있어","지나간 일은 다음 행동까지 고정하진 않아"],
    human:["인간 세계는 지옥과 달라 보여도 이상한 점은 놀랍도록 비슷해","인간들이 악마를 상상하는 방식에는 자기 두려움이 많이 섞여 있어","짧은 삶 때문에 인간의 규칙은 더 급하게 움직이는 것 같아"],
    work:["효율만 따지면 팀이 먼저 망가질 때가 있어","일은 결국 누가 책임지고 누가 위험을 떠안는지에서 본색이 보여","규칙이 귀찮아도 사고가 난 뒤에는 왜 있었는지 알게 되지"],
    imp:["현장에서는 신분보다 누가 제대로 움직이는지가 더 빨리 드러나","임프라는 이유로 능력까지 낮게 보는 건 게으른 편견이야","작은 회사일수록 한 사람의 감정이 업무 전체에 바로 번져"],
    goetia:["혈통으로 받은 의무가 개인의 인생 전체를 대신 정할 수는 없어","가문의 명예라는 말은 자녀에게 너무 쉽게 무게로 넘어가","마법과 신분이 강할수록 사적인 선택도 정치처럼 취급되기 쉽지"],
    sin:["거대한 상징이 되어도 사적인 선택은 사라지지 않아","자신이 대표하는 욕망을 이해하는 것과 끌려다니는 건 달라","통치자의 이미지와 개인 감정이 충돌하면 둘 다 숨기기 어려워"],
    party:["즐기는 것과 스스로를 망가뜨리는 건 완전히 달라","사람이 많은 자리가 외로움을 없애주는 건 아니야","좋은 파티는 모두가 같은 속도로 놀 필요가 없을 때 완성돼"],
    fame:["유명해질수록 사람들은 실제 사람보다 기대하는 캐릭터를 먼저 봐","박수는 커질수록 멈출 때의 조용함도 커져","이미지를 지키는 일이 본인을 지우기 시작하면 오래 버티기 어려워"],
    law:["법이 있다는 사실보다 누구에게 똑같이 적용되는지가 더 중요해","판결은 끝나는 문장이 아니라 이후 결과를 책임지는 시작이야","권력이 큰 사람일수록 규칙 밖에 서기 쉬워"],
    hellsociety:["출신과 계급이 다르면 같은 장소도 전혀 다르게 보일 수 있어","누가 어디에 살 수 있는지부터 이미 권력 차이가 드러나","지옥도 결국 수많은 사람들이 얽혀 사는 사회야"],
    violence:["싸움에서 이기는 것과 문제를 해결하는 건 같은 일이 아니야","무기를 들 수 있다는 사실보다 언제 내려놓는지가 더 어렵지","위험한 상황에서는 살아서 돌아오는 판단이 먼저야"],
    leisure:["쉬는 방식에도 성격이 그대로 드러나","사소한 취미가 큰 문제보다 사람을 더 솔직하게 보여줄 때가 있어","같이 하는 사람이 바뀌면 같은 놀이도 완전히 다른 기억이 돼"],
    friendship:["친구는 늘 동의하는 사람이 아니라 선을 넘었을 때 말해주는 사람이기도 해","같이 웃는 것보다 엉망인 날 남아 있는지가 더 오래 기억돼","도움을 주는 것과 상대 대신 결정하는 건 달라"],
    selfworth:["가치가 성과 하나에 묶이면 실패할 때 사람 전체가 무너져","약한 모습을 보였다고 능력까지 사라지는 건 아니야","쓸모를 증명해야만 사랑받는 관계는 결국 사람을 소모시켜"],
    money:["가격을 매길 수 있다는 것과 실제 가치가 있다는 건 다른 말이야","수익이 난다고 정당한 사업이 되는 건 아니지","돈은 선택지를 늘리지만 모든 선택의 이유가 되면 사람을 놓치기 쉬워"],
    food:["음식 취향은 별것 아닌 것 같아도 기억이랑 사람을 같이 끌어와","같이 먹는 자리가 편하면 말도 훨씬 자연스럽게 나오지","누군가 뭘 좋아하는지 기억하는 건 작은 친밀감이야"],
    culture:["문화 차이는 틀린 답보다 익숙한 답이 다른 데서 생겨","출신을 이유로 성격까지 단정하는 순간 편견이 시작돼","같은 지옥 안에서도 사는 곳이 다르면 상식부터 달라질 수 있어"]
  };
  ...
  const low=[
    (g,c,r)=>g+" "+c+". "+r+".",
    (g,c,r)=>g+" 내 쪽 기준은 단순해. "+r+". 그리고 "+c+".",
    (g,c,r)=>g+" 먼저 말하자면 "+c+". 그래서 난 "+r+".",
    (g,c,r)=>g+" 이걸 굳이 정리하면 "+r+". "+c+".",
    (g,c,r)=>g+" 적어도 하나는 확실해. "+c+". "+r+".",
    (g,c,r)=>g+" 좋은 말로 포장할 생각은 없어. "+r+". "+c+".",
    (g,c,r)=>g+" 내가 신경 쓰는 건 다른 데 있어. "+c+". 결국 "+r+".",
    (g,c,r)=>g+" 겉으로 보이는 답보다 "+c+". 난 그쪽에서 "+r+".",
    (g,c,r)=>g+" 상황마다 다르겠지만 "+c+". 내 기준은 "+r+".",
    (g,c,r)=>g+" 솔직히 말하면 "+r+". 그 이유도 결국 "+c+".",
    (g,c,r)=>g+" 남들이 어떻게 말하든 "+c+". 그래서 "+r+".",
    (g,c,r)=>g+" 한쪽 편만 들 생각은 없어. "+c+". 나는 "+r+".",
    (g,c,r)=>g+" 결론부터 내리진 마. "+c+". 적어도 난 "+r+"."
  ];
  const high=[
    (w,c,s)=>w+" "+c+". 요즘은 "+s+".",
    (w,c,s)=>w+" 예전보다 먼저 보이는 건 "+c+". 그리고 "+s+".",
    (w,c,s)=>w+" 나도 답이 조금 바뀌었어. "+c+". "+s+".",
    (w,c,s)=>w+" 이 얘기에서 숨기기 싫은 부분은 "+c+". "+s+".",
    (w,c,s)=>w+" 네가 있어서 그런지 "+c+"라는 쪽까지 생각하게 돼. "+s+".",
    (w,c,s)=>w+" 예전엔 단순하게 봤는데 지금은 "+c+". 덕분에 "+s+".",
    (w,c,s)=>w+" 내 경험을 끼워 말하면 "+c+". 그래서 "+s+".",
    (w,c,s)=>w+" 솔직한 답은 이거야. "+c+". 그리고 "+s+".",
    (w,c,s)=>w+" 내가 바뀐 부분이 있다면 "+c+"를 무시하지 않게 된 거야. "+s+".",
    (w,c,s)=>w+" 이제는 "+c+"라는 말을 전보다 더 믿어. "+s+".",
    (w,c,s)=>w+" 네 앞에서는 인정할 수 있겠네. "+c+". "+s+".",
    (w,c,s)=>w+" 완벽한 답은 아니지만 "+c+". 적어도 "+s+".",
    (w,c,s)=>w+" 오래 생각해보니 "+c+". 그래서인지 "+s+"."
  ];
  const lc=["그 이상은 아직 말하고 싶지 않아.","일단 내 답은 여기까지야.","나머지는 실제 상황이 오면 보겠지.","이걸로 내가 다 설명됐다고 생각하진 마.","지금은 그 정도만 알아둬.","더 캐면 오히려 답이 짧아질 거야.","결론을 대신 내려주진 마.","그 정도면 충분히 대답했지?","다음 얘기로 넘어가도 되겠네.","내가 먼저 더 말할 때까지는 여기서 끝.","좋아, 이 주제는 잠깐 닫자.","이 이상 단순하게 만들 순 없어.","적어도 지금 답은 그래."];
  const hc=["네가 듣고 있으니 이 정도까지 말하게 되네.","이 얘기를 하고도 어색하지 않은 건 꽤 큰 변화야.","나중에 생각이 더 바뀌면 먼저 말해줄 수도 있겠어.","네 반응이 과하지 않아서 다행이야.","이제는 이런 주제를 굳이 피할 필요는 없겠네.","말하고 나니 생각보다 덜 무겁다.","다음엔 네 생각도 더 길게 듣고 싶어.","같이 오래 얘기해온 덕분에 답이 조금 선명해졌어.","이 정도 속내는 맡겨도 되겠지.","예전의 나라면 여기까지 안 왔을 거야.","네가 알고 있어도 불편하지 않은 답이 됐네.","이건 우리 대화 안에 그냥 두자.","오늘은 여기까지 말한 걸 후회하진 않을 것 같아."];
  ...
  const make=(c,t,n)=>{
    ...
    const follow=p2[(hash(id+"f")+n)%p2.length];
    const lo=low[(hash(id+"l")+n)%low.length](pick(c.guard,id+"g"),cue,c.rule);
    const hi=high[(hash(id+"h")+n)%high.length](pick(c.warm,id+"w"),cue,c.soft);
    const lo2=pick(lc,id+"lc"),hi2=pick(hc,id+"hc");
