...
assert.equal(legacyDialogueLocalizationCheck.version,19,"dialogue tuning migration version missing");
...
assert.equal(fullLegacyRefRepairCheck.version,19,"full character-ref repair must advance dialogue preset version");
...
assert.equal(tunedDialogueSyncCheck.version,19,"tuned dialogue sync must advance preset version");
...
assert.equal(soloDialogueSyncCheck.version,19,"solo TALK sync must advance preset version");
context.window.HV_STORY_PACKS.length=storyPackCountBeforeTuning;
