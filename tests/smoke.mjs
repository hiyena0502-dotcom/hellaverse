...
assert.equal(legacyDialogueLocalizationCheck.version,20,"dialogue tuning migration version missing");
...
assert.equal(fullLegacyRefRepairCheck.version,20,"full character-ref repair must advance dialogue preset version");
...
assert.equal(tunedDialogueSyncCheck.version,20,"tuned dialogue sync must advance preset version");
...
assert.equal(soloDialogueSyncCheck.version,20,"solo TALK sync must advance preset version");
context.window.HV_STORY_PACKS.length=storyPackCountBeforeTuning;
