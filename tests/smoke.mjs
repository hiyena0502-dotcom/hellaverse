...
assert.equal(legacyDialogueLocalizationCheck.version,21,"dialogue tuning migration version missing");
...
assert.equal(fullLegacyRefRepairCheck.version,21,"full character-ref repair must advance dialogue preset version");
...
assert.equal(tunedDialogueSyncCheck.version,21,"tuned dialogue sync must advance preset version");
...
assert.equal(soloDialogueSyncCheck.version,21,"solo TALK sync must advance preset version");
context.window.HV_STORY_PACKS.length=storyPackCountBeforeTuning;
